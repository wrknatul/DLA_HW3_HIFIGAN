...
class SubDiscriminator(nn.Module):
    def __init__(self, norm):
        ...
        self.conv_layers = nn.ModuleList([
            norm(nn.Conv1d(1, 128, kernel_size=15, stride=1, groups=1, dilation=1, padding=7)),
            norm(nn.Conv1d(128, 256, kernel_size=41, stride=4, groups=4, dilation=1, padding=20)),
