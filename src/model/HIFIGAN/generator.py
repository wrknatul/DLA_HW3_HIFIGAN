...
class Generator(nn.Module):
    def __init__(self, input_channels=80, upsample_rates=(8, 8, 2, 2), 
        ...
        self.conv_pre = nn.Conv1d(input_channels, upsample_initial_channel, 7, padding=3)
